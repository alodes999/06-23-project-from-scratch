...
CONNECTION.execute("CREATE TABLE IF NOT EXISTS mediums (id INTEGER PRIMARY KEY, name TEXT);")
# CONNECTION.execute("CREATE TABLE IF NOT EXISTS games (id INTEGER PRIMARY KEY, name TEXT, genres_id INTEGER, mediums_id INTEGER, FOREIGN KEY(genres_id) REFERENCES genres(id), FOREIGN KEY(mediums_id) REFERENCES mediums(id) );")
